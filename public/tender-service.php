...
<html lang="zxx">
<head>
<title>The Quarters | Tender Services</title>
<!-- Meta-Tags -->
	...
	<div id="demo-1" data-zs-src='["images/4.jpg", "images/2.jpg", "images/1.jpg","images/3.jpg"]' data-zs-overlay="dots">
		...
		<div class="container"> 			
				<div class="row">
					...
					<img src="quarter logo.png" style="width:300px; height:150px;" align="middle" alt="">
					</div>
					<div class="col-md-4 col-sm-4"></div>
				</div><br>
				<div class="row">
...
<div class="agile_menu" id="menu">
		<div class="container">
            <h3 style="text-align:center">
                We offer special service packages to:
            </h3><br><br><br>
            <div class="row">
                <div class="col-md-4">
                    <h3>Event Decor</h3>
                    <p>&nbsp;</p>
                <img src="images/tender/1.jpeg">
                </div>
               
                <div class="col-md-4 col-xs-12 col-lg-4">
                <h3>Corporate Personel</h3>
                <p>&nbsp;</p>
               <img src="images/tender/2.jpeg">
                </div>
                
                <div class="col-md-4 col-xs-12 col-lg-4">
                <h3>Schools</h3>
                <p>&nbsp;</p>
                <img src="images/tender/3.jpeg">
                </div> 
            </div>
            <br/>
            <div class="row">
                ...
                <h3>Hotels</h3>
                <p>&nbsp;</p>
                <img src="images/tender/6.jpeg">
                </div>
             
                <div class="col-md-4 col-xs-12 col-lg-4">
                <h3>Hospitals</h3>
                <p>&nbsp;</p>
                <img src="images/tender/7.jpeg">
                </div>
