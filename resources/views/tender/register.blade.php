...
@section('content')
    <div class="container">
        <div class="card card-register mx-auto mt-5">
            ...
            <div class="card-body">
                <form action="{{ route('tender_register') }}" method="post">
                    {{ csrf_field() }}
                    ...
                    <div class="form-group {{ $errors->has('gender') ? ' has-error' : '' }}">
                        ...
                        <input class="form-control" name="service" value="{{ old('service') }}" id="service" type="text" placeholder="Enter the service you prefer" required>
                ...
                <div class="text-center">
                    <a class="d-block small mt-3" href="{{ route('tender_toLogin') }}">Login Page</a>
